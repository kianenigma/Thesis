...
Design in Notion is final. Write a set of requirements and explain \textbf{why} the design respects it. 

related work: say where you fit in the literature overlay. No need to brag and\textbf{compare with others}.
