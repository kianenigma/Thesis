...
%Ana: To me, I would still like to see here a main research question, something that translate the main goal (from above) into a question. Something as simple as "How can we use concurrency to improve the throughput of blockchain systems?" 
...
The rest of this thesis is organized as follows: \todo[inline]{write once the outline is done. This
