...
\todo[inline]{Mention at some point: Static hints must align with the guidelines of the validation.}

\subsubsection{Account Nonce} \label{chap_bg:subsec:nonce}

\nomenclature{Account Nonce}{An initiger linked to each account and incremented per transaction. Used to prevent replay attacks.}
